public class Aluno {
    ...
    public Aluno (String curso, String matricula, String descricao, int id, String nome, String email, String senha, String vinculo, String telefone, String projeto){
        setCurso(curso);
